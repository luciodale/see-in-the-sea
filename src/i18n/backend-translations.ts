...
export const backendTranslations = {
  en: {
    ...
    'error.access-denied-admin':
      'Access denied. Admin role required for admin uploads.',
    'error.access-denied-admin-delete':
      'Access denied. Admin role required for admin delete.',
    ...
    'error.server-config-missing':
      'Server configuration error: Missing R2 bucket or database.',
    ...
    'error.failed-to-fetch-contest-categories':
      'Failed to fetch contest and categories',
  ...
  it: {
    ...
    // Authentication errors
    'error.access-denied-admin':
      'Accesso negato. Ruolo admin richiesto per caricamenti admin.',
    'error.access-denied-admin-delete':
      'Accesso negato. Ruolo admin richiesto per eliminazione admin.',
    'error.insufficient-permissions': 'INSUFFICIENT_PERMISSIONS',
    ...
    'error.user-email-required':
      'Email utente richiesta per caricamenti admin.',
    ...
    'error.submissions-closed':
      'Le candidature sono chiuse per questo contest.',
    'error.submissions-locked':
      'Non puoi modificare le tue candidature dopo aver completato il pagamento.',
    'error.need-submission-to-pay':
      'Devi candidarti ad almeno una categoria per poter pagare.',
    ...
    'error.server-config-missing':
      'Errore di configurazione del server: Bucket R2 o database mancanti.',
...
export type BackendTranslationKey =
  keyof (typeof backendTranslations)[typeof defaultLang];
