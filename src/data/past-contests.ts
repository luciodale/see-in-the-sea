...
export const pastContestsData: Contest[] = [
  {
    ...
    judges: [
      ...
      {
        id: 'op8X2QsTFqtqurzj3-fQw',
        fullName: 'Scott Portelli',
        r2ImageId: 'judges/op8X2QsTFqtqurzj3-fQw/wWmwnndDog-ZNj4_tPggf',
      },
      {
        id: 'ChybiBjKXJDO8Q37XIUeM',
        fullName: 'Imran Ahmad',
        r2ImageId: 'judges/ChybiBjKXJDO8Q37XIUeM/HB2IlHboREsKRjCNRzkaL',
      },
    ],
    categories: [],
  },
