...
async function main() {
  console.log('🔍 Parsing HTML content for uw-2013...');
...
`;
  ...
  writeFileSync('./migration/uw-2013.ts', migrationFileContent);

  console.log('\n✅ Migration complete!');
  console.log(
    `📝 Generated: migration/uw-2013.ts with ${migrationData.length} submissions`
  );
